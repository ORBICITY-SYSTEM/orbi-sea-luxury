  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden">
      ...
      <div className={`relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center transition-all duration-700 ${
        ...
        <div className="flex flex-col items-center mb-8 md:mb-14 animate-fade-in-up delay-400">
          <Button
            size="lg"
            onClick={scrollToRooms}
            className="group relative bg-gradient-to-r from-gold-400 via-gold-300 to-gold-400 hover:from-gold-500 hover:via-gold-400 hover:to-gold-500 text-navy-900 font-bold text-sm md:text-lg px-8 md:px-14 py-4 md:py-6 rounded-full transition-all duration-500 hover:scale-105 tracking-wider uppercase overflow-hidden shadow-[0_4px_20px_rgba(212,175,55,0.4)] hover:shadow-[0_8px_30px_rgba(212,175,55,0.6)]"
          >
            {/* Shine effect */}
