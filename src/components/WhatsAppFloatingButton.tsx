      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              asChild
              className="h-12 px-5 rounded-full shadow-medium border border-success/25 bg-success text-success-foreground hover:bg-success/90 relative overflow-hidden gap-2"
            >
              <a
                href={whatsappUrl}
                target="_blank"
              ...
              >
                ...
                <span className="relative font-medium text-sm">WhatsApp</span>
              </a>
            </Button>
          </TooltipTrigger>
          <TooltipContent side="left" className="bg-card text-foreground border-border">
            <p>მოგვწერე WhatsApp-ზე</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    </motion.div>
