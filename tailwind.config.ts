...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      // 4-Point Grid Line Heights - All values divisible by 4px
      lineHeight: {
        '3': '0.75rem',       // 12px
        '4': '1rem',          // 16px
        '5': '1.25rem',       // 20px
      ...
      fontSize: {
        // Font sizes with 4-point grid line-heights
        ...
        'hero': ['4.5rem', { lineHeight: '5rem', letterSpacing: '0.02em' }],      // 72px / 80px
        'hero-sm': ['3rem', { lineHeight: '3.5rem', letterSpacing: '0.02em' }],   // 48px / 56px
      },
      letterSpacing: {
        'luxury': '0.15em',
        'wide-luxury': '0.25em',
